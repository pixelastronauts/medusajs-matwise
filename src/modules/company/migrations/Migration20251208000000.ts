...
export class Migration20251208000000 extends Migration {
  async up(): Promise<void> {
    ...
    // Unique constraint: a customer can only be in one company
    this.addSql(`
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_employee_customer_unique" ON "employee" ("customer_id") WHERE "deleted_at" IS NULL;
    `);
  }
